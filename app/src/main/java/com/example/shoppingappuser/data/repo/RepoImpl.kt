package com.example.shoppingappuser.data.repo


import android.net.Uri
import android.util.Log
import com.example.shoppingappuser.common.ADDTOFAV
import com.example.shoppingappuser.common.ADD_TO_CART
import com.example.shoppingappuser.common.PRODUCT_COLLECTION
import com.example.shoppingappuser.common.ResultState
import com.example.shoppingappuser.common.USER_COLLECTION
...
class RepoImpl @Inject constructor(
    ...
    override fun getuserById(uid: String): Flow<ResultState<UserDataParent>> = callbackFlow {
        ...
        awaitClose {
            // If you need to cancel any ongoing operations, do it here
        }
    }
